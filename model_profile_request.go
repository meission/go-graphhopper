...
type ProfileRequest struct {
	// The built-in profile your new custom profile shall be based on. Currently we only support `car` but you can add size restrictions and speed reduction to get similar profiles like `small_truck` and `truck`. Contact us to learn more about this.
	Profile *string `json:"profile,omitempty"`
	Bounds *ProfileRequestBounds `json:"bounds,omitempty"`
...
// SetBounds gets a reference to the given ProfileRequestBounds and assigns it to the Bounds field.
