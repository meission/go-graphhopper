...
// RequestRelationsInner struct for RequestRelationsInner
type RequestRelationsInner struct {
	GroupRelation *GroupRelation
	JobRelation *JobRelation
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *RequestRelationsInner) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into GroupRelation
	err = json.Unmarshal(data, &dst.GroupRelation);
	if err == nil {
		jsonGroupRelation, _ := json.Marshal(dst.GroupRelation)
		if string(jsonGroupRelation) == "{}" { // empty struct
			dst.GroupRelation = nil
		} else {
			return nil // data stored in dst.GroupRelation, return on the first match
		}
	} else {
		dst.GroupRelation = nil
	}

	// try to unmarshal JSON data into JobRelation
	err = json.Unmarshal(data, &dst.JobRelation);
	if err == nil {
		jsonJobRelation, _ := json.Marshal(dst.JobRelation)
		if string(jsonJobRelation) == "{}" { // empty struct
			dst.JobRelation = nil
		} else {
			return nil // data stored in dst.JobRelation, return on the first match
		}
	} else {
		dst.JobRelation = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(RequestRelationsInner)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src RequestRelationsInner) MarshalJSON() ([]byte, error) {
	if src.GroupRelation != nil {
		return json.Marshal(&src.GroupRelation)
	}

	if src.JobRelation != nil {
		return json.Marshal(&src.JobRelation)
	}
...
type NullableRequestRelationsInner struct {
	value *RequestRelationsInner
	isSet bool
}

func (v NullableRequestRelationsInner) Get() *RequestRelationsInner {
	return v.value
}

func (v *NullableRequestRelationsInner) Set(val *RequestRelationsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestRelationsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestRelationsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestRelationsInner(val *RequestRelationsInner) *NullableRequestRelationsInner {
	return &NullableRequestRelationsInner{value: val, isSet: true}
}

func (v NullableRequestRelationsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestRelationsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
