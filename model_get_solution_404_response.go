...
// checks if the GetSolution404Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSolution404Response{}

// GetSolution404Response struct for GetSolution404Response
type GetSolution404Response struct {
	// Error message
...
func (o GetSolution404Response) MarshalJSON() ([]byte, error) {
...
func (o GetSolution404Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetSolution404Response struct {
	value *GetSolution404Response
	isSet bool
}

func (v NullableGetSolution404Response) Get() *GetSolution404Response {
	return v.value
}

func (v *NullableGetSolution404Response) Set(val *GetSolution404Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSolution404Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSolution404Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSolution404Response(val *GetSolution404Response) *NullableGetSolution404Response {
	return &NullableGetSolution404Response{value: val, isSet: true}
}

func (v NullableGetSolution404Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSolution404Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
