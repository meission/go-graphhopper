...
// checks if the GHErrorHintsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GHErrorHintsInner{}

// GHErrorHintsInner struct for GHErrorHintsInner
type GHErrorHintsInner struct {
...
func (o GHErrorHintsInner) MarshalJSON() ([]byte, error) {
...
func (o GHErrorHintsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGHErrorHintsInner struct {
	value *GHErrorHintsInner
	isSet bool
}

func (v NullableGHErrorHintsInner) Get() *GHErrorHintsInner {
	return v.value
}

func (v *NullableGHErrorHintsInner) Set(val *GHErrorHintsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGHErrorHintsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGHErrorHintsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGHErrorHintsInner(val *GHErrorHintsInner) *NullableGHErrorHintsInner {
	return &NullableGHErrorHintsInner{value: val, isSet: true}
}

func (v NullableGHErrorHintsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGHErrorHintsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
